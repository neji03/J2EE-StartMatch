...
<!-- FIN DE NAVBAR DYNAMIQUE -->
 ...
 <div class="row " id="d2"> 
            ...
            <div class="col-md-12 cover-photo">
                <img onerror="this.src='https://encrypted-tbn0.gstatic.com/images?q=tbn:ANd9GcQ2xn7Fx99ZeNNKtLt139ioNchBq1fsNQc-AdCp04CgTA&s'" src="data:image/jpeg;base64,<c:out value='${requestScope.user1.cpic}'/>" style="box-shadow:rgb(71, 90, 106) 3px 3px 6px 0px;" height="200px" width="100%" >
  
            </div>
            <div class="offset-md-5 col-md-2 text-center"id="pdp2">
                <img onerror="this.src='https://design.ncsu.edu/doctor-of-design/wp-content/uploads/sites/7/2021/07/late-career-persona-philip.jpg'" src="data:image/jpeg;base64,<c:out value='${requestScope.user1.ppic}'/>" style="box-shadow:rgb(71, 90, 106) 3px 3px 6px 0px;" height="75" width="81"  class="rounded-circle" >
	            ...
	            <c:forEach var="post" items="${posts}">
					<c:if test="${post.utilisateur.idUser eq requestScope.user1.idUser}">				        
				                <div class="card mb-3">
				                    <div class="card-body">
				                        <div class="flexy">
				                            <img href='/OtherPorfile' onerror="this.src='https://design.ncsu.edu/doctor-of-design/wp-content/uploads/sites/7/2021/07/late-career-persona-philip.jpg'" class="img-fluid eclipse" src="${post.utilisateur.ppic}" alt="person/startup_img">
				                            <div class="flexy-1">
