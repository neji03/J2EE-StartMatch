    ...
    <div class="row d-flex align-items-center ">
        ...
        <div class="col-md-2 text-center" id="profile-name">
            ...
            <c:if test="${sessionScope.IsPerson==1}">
                <a href='./ConsultMyProfile.jsp'><h6><c:out value="${sessionScope.PFirst_name} ${sessionScope.PLast_name}"/></h6></a>
            </c:if>
            <c:if test="${sessionScope.IsPerson==0}">
                <a href='./ConsultMyProfile.jsp'><h6><c:out value="${sessionScope.SName}"/></h6></a>
            </c:if>
        </div>
